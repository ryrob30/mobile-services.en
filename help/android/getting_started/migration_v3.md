...
uuid: 5ea86dcd-d542-422c-acfc-c189861080cd
index: y
internal: n
snippet: y
translate: y
...
* There is little impact to sending in extra data.
  ...
  These values will not appear in reports until they are mapped using processing rules. For more information, see [Processing Rules and Context Data](../getting_started/proc_rules.md#concept_1BCA9101D7CF4815ACEB23725816964B).
