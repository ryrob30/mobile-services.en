...
uuid: 3cab7b3b-a73f-47d0-b0cb-b99b7a128b39
index: y
internal: n
snippet: y
translate: y
...
<table id="table_953334C153F9490ABDB5174E26572C47"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Triggered when the application is used on a particular day. </p> <p type="important">Note:  This metric is not automatically stored in an Analytics metric. You must create a processing rule that sets a custom event to capture this metric. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Triggered when the application is used during a particular month. </p> <p type="important">Note:  This metric is not automatically stored in an Analytics metric. You must create a processing rule that sets a custom event to capture this metric. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_2F24CB1C8E8448AE9A94D3AD57C21662"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Number of days since the application version number has changed. </p> <p type="important">Note:  This metric is not automatically stored in an Analytics variable. You must create a processing rule to copy this value to an Analytics variable for reporting. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Number of launches since the application version number has changed. </p> <p type="important">Note:  This metric is not automatically stored in an Analytics variable. You must create a processing rule to copy this value to an Analytics variable for reporting. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Stores the name of the mobile service provider as provided by the device. </p> <p type="important">Note:  This metric is not automatically stored in an Analytics variable. You must create a processing rule to copy this value to an Analytics variable for reporting. </p> </td> 
  </tr> 
  <tr> 
