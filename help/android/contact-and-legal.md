...
uuid: 4d1fa975-48aa-4c52-90d3-0db1a22dc3eb
index: y
internal: n
snippet: y
---
...
* Check [Experience Cloud Learn & Support](https://helpx.adobe.com/marketing-cloud.html) for advice, tips, and FAQs. 
* Ask us a quick question on Twitter [AdobeExpCare](https://twitter.com/AdobeExpCare) 
* Log an incident on our [customer portal](https://customers.omniture.com/login.php) 
* Contact the [Customer Care](https://helpx.adobe.com/marketing-cloud/contact-support.html) team directly 
* Check the availability and status of [Experience Cloud Solutions](https://status.adobe.com/)
