...
Here is some informaton about how to implement the Universal Windows Platform library.
...
>[!IMPORTANT]
>
>The version of `ADBMobile.winmd` does not reflect the version of the library. The `.winmd` file contains only metadata only, and has a version number of `255.255.255.255`, which is accepted behavior according to Microsoft. (For more information, see [How do I add assembly information for a WinRT C++ / CX component dll?](https://social.msdn.microsoft.com/Forums/windowsapps/en-US/6bcccaee-aa53-4770-bd5b-1205977f1ca7/how-do-i-add-assembly-information-for-a-winrt-c-cx-component-dll?forum=winappswithnativecode).) To check the version of the library you are using, check the version of the underlying `ADBMobile.dll` file.
