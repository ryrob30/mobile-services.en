...
uuid: 62a6a7ae-c0a9-409f-864c-e5e8cb4a4b3d
index: y
internal: n
snippet: y
translate: y
...
<table id="table_164CA94BE9BD44E59F60389A6D148DF0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Tracks an action that occurred in the background, which suppresses lifecycle events from firing in certain scenarios. </p> <p type="tip">Note:  This method should only be called in code that runs while your app is in the background. </p> <p> <b>Syntax:</b> </p> 
    <codeblock class="syntax c">
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Clears all hits from the offline queue. </p> <p> <b>Syntax:</b> </p> 
    ...
    </codeblock> <p> <p type="warning">Note:  Use caution when clearing the queue manually. This process cannot be reversed. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> trackPushMessageClickThrough </td> 
   <td colname="col2"> <p>Tracks a push message click-through. </p> <p> <p type="important">Note:  This method does not increment page views. </p> </p> <p><b>Syntax:</b> </p> 
    <codeblock class="syntax c">
