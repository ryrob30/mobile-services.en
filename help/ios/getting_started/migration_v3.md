...
uuid: edef7b5e-41ca-400e-abce-3ffd0c91f29f
index: y
internal: n
snippet: y
translate: y
...
* There is little impact to sending in extra data.
  ...
  These values will not appear in reports until they are mapped by using processing rules. For more information, see [Processing Rules and Context Data](../getting_started/proc_rules.md#concept_4DAF0756D0DB43BD8C0627E023665FA5).
